          ...
          <>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  onClick={() => navigate(`/companies/${selectedCompany.cik}/fundamentals`)}
                  className="px-4 py-2 border border-blue-200 bg-blue-50 text-blue-700 rounded-md hover:bg-blue-100 flex items-center gap-2"
                >
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button
                  onClick={() => navigate(`/companies/${selectedCompany.cik}/fundamentals`)}
                  className="px-4 py-2 border border-blue-200 text-blue-700 rounded-md hover:bg-blue-50"
                >
                  Open Fundamentals View
                </button>
                <button
