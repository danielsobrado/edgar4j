...
public class Company {
    ...
    @Column(name = "current_stock_price", precision = 19, scale = 4)
    ...
    @Column(name = "pb_ratio", precision = 19, scale = 4)
    private BigDecimal pbRatio;

    @Column(name = "beta", precision = 19, scale = 4)
    ...
    @Column(name = "last_market_data_update")
    private LocalDateTime lastMarketDataUpdate;
