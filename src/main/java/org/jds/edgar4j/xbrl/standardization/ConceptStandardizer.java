...
public class ConceptStandardizer {
    ...
    static {
        ...
        STANDARD_MAPPINGS.put("DividendsPerShare", ConceptMapping.builder()
                .standardConcept("DividendsPerShare")
                ...
                .signConvention(SignConvention.POSITIVE)
                .description("Common stock dividends per share")
                .build());

        STANDARD_MAPPINGS.put("DividendsPaid", ConceptMapping.builder()
                .standardConcept("DividendsPaid")
    ...
    private String fuzzyMatch(String concept) {
        ...
        if (lower.contains("dividend") && lower.contains("share")) {
    ...
    public static class StandardizedData {
        ...
        public Map<String, BigDecimal> getLatestValues() {
            return facts.stream()
                    .filter(fact -> fact.getValue() != null)
