...
public class ElasticsearchStartup implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        createIndexAndMappingIfNeeded(Form8K.class, "form8k", "mappings/form8k_mapping.json");
        createIndexAndMappingIfNeeded(Form13F.class, "form13f", "mappings/form13f_mapping.json");
